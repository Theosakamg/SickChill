...
class ZoneTelechargementProvider(DDLProvider):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self):
        ...
        self.urls = {'base_url': 'https://ww1.zone-telechargement1.com',
                     'search': 'https://ww1.zone-telechargement1.com/index.php?do=search',
                     'rss': 'https://ww1.zone-telechargement1.com/rss.xml'}
