...
def searchForNeededEpisodes():
    ...
    if not didSearch:
        logger.log(
            "No NZB/Torrent/DDL providers found or enabled in the sickchill config for daily searches. Please check your settings.",
            logger.INFO)
...
def searchProviders(show, episodes, manualSearch=False, downCurQuality=False):
    ...
    if not didSearch:
        logger.log("No NZB/Torrent/DDL providers found or enabled in the sickchill config for backlog searches. Please check your settings.",
                   logger.INFO)
